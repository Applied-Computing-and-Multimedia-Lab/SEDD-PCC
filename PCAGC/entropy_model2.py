...
def estimate_bpp_Y(likelihood, num_cube, num_pixels=None, input=None, likelihood_bound: float = 1e-9):
    """estimate bits-per-pixel
...
def estimate_bpp_Z(likelihood, num_cube, num_pixels=None, input=None, likelihood_bound: float = 1e-9):
    """estimate bits-per-pixel
...
def estimate_bpp_eval(likelihood, num_cube, num_pixels=None, input=None, likelihood_bound: float = 1e-9):
    """estimate bits-per-pixel
