...
import time
import csv
from data_utils import load_sparse_tensor, sort_spare_tensor, scale_sparse_tensor,load_sparse_tensor_attri
from data_utils import write_ply_ascii_geo, read_ply_ascii_geo, write_ply_ascii_attri
from pc_error import pc_error
from data_loader import make_data_loader_eval
...
def test(filedir, ckptdir_list,Tstage, outdir, resultdir,step='0',scaling_factor=1.0,
    ...
    for idx, ckptdir in enumerate(ckptdir_list):
        ...
        if (step=='0'):
            coder = ICoder(model=model, filename=filename)   #con
...
if __name__ == '__main__':
    ...
    parser.add_argument("--filedir", default='/home/user/Desktop/unified/SEDDPCC/PCAGC/test_data/8iVFB')
    # parser.add_argument("--filedir", default='/home/user/Desktop/unified/SEDDPCC/PCAGC/test_data/Owlii')
    parser.add_argument("--Tstage", type=int, default=1, help='training stage')
    ...
    ckptdir_list = [
                    # '/home/user/Desktop/unified/SEDDPCC/PCAGC/ckpts/PCAC/epoch_148.pth'
                    # '/home/user/Desktop/unified/SEDDPCC/PCAGC/ckpts/PCGC/epoch_80.pth'
                    # '/home/user/Desktop/unified/1219_test_IRN/ckpts/101_stage2_nohyper_noTG_IRN/best.pth'
                    '/home/user/Desktop/unified/SEDDPCC/PCAGC/ckpts/0516_SEDD_RWTT/epoch_76.pth'
